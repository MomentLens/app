...
- The same holds for the `profile` reference, whose photo is the avatar's object (arch:face_reference). While Do Not Publish is active, the owner's reference list shows the placeholder in its place. Their other reference photos stay visible to them.
