...
momentlens--complete-application-flow--feature-reference 26226 tok  MomentLens — complete application flow & feature reference
...
spec §3            733 tok  Event lifecycle (end to end)
...
spec §5           1183 tok  Edge cases & exception handling
